...
ActiveRecord::Schema.define(version: 2020_04_04_072438) do
  ...
  create_table "shopping_experiences", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.index ["user_id"], name: "index_shopping_experiences_on_user_id"
  end
  ...
  add_foreign_key "shopping_experiences", "users"
end
